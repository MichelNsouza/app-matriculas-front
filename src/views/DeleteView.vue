...
<template>
  ...
  <section class="justify-content-md-center align-content-md-center mt-3">
  ...
  <section class="vw-100 justify-content-md-center align-content-md-center mt-3 px-2 py-4">
